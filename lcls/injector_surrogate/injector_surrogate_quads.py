...
class Surrogate_NN:
    ...
    def __init__(self, model_info_file = 'lcls/configs/model_info.json',
    ...
    def load_saved_model(self, model_path = './', model_name = 'model_OTR2_NA_rms_emit_elu_2021-07-27T19_54_57-07_00'):
        
            self.model_1 = load_model(model_path + model_name +'.h5')
            self.savepath = model_path +'figures/'
            
    def load_scaling(self,scalerfilex = 'lcls/data/transformer_x.sav', scalerfiley = 'lcls/data/transformer_y.sav'):
