...
class Lcls(Base):
    ...
    def set_params(self, params):
        ...
        self.params.calc_bmag = getattr(params, 'calc_bmag', True)
    ...
    def beamsizes_fn(self, config_quad, verbose=True):
        ...
        if self.add_noise:
            xrms = beamsizes[0] + np.random.rand() / self.noise_red
            yrms = beamsizes[1] + np.random.rand() / self.noise_red
